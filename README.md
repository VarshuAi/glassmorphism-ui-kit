...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/glassmorphism-ui-kit.git
   cd glassmorphism-ui-kit
   ```
...
[![Repo](https://img.shields.io/badge/glassmorphism-ui-kit-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/glassmorphism-ui-kit)
